...
*/
public class BuscarRubroProve extends JDialog implements ActionListener, MouseListener, KeyListener  {
	...
	public BuscarRubroProve(Frame padre) {
	...
	public void listarProveRubXCod(){	
		...
		codigoProvRub=objmant.codproverubro;
	...
	/***********************************************************************************************/
     ...
     /********AGREGAR RUBRO Y MARCA AL PROVEEDOR************************/
 	 public void agregarRubroProveedor(){
 		 ...
 		 if(verificar==0){
 			objmant=new MantProveedor();
			CODPROVE=""+objmant.codproverubro;
			est=1;
 		 }
