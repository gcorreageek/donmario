...
*/
public class TipoCambio extends JPanel implements ActionListener {
	...
	public TipoCambio() {
		try {
			System.out.println("ENTRA TIPOCANBIO");
			...
			pnlPrincipal.setBounds(12, 7, 368, 192);
...
//		String titulo2[]={"COD_PROD","NOM_PROD","COD_MAR","NOM_MAR","UMED_PROD","OBS_PROD"};
		...
		System.out.println("ENTRASASSSSSSSSSASSSASASAS");
