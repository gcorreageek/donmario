...
*/
public class BuscarRubroProveSol extends JDialog implements ActionListener, MouseListener, KeyListener  {
	...
	ReporteSolProve objRepsolprove;
	GUI objGUI;
	
	
	public BuscarRubroProveSol(Frame padre) {
		...
		try {
			...
			txtNombre.setText(objRepsolprove.nomprove);
	...
	public void listarProveRubXCod(){	
		...
		objRepsolprove= new ReporteSolProve();
		codigoProvRub=objRepsolprove.codproverubro;
	...
	/***********************************************************************************************/
     ...
     /********AGREGAR RUBRO Y MARCA AL PROVEEDOR************************/
 	 public void agregarRubroProveedor(){
 		 ...
 		 if(verificar==0){
 			objRepsolprove=new ReporteSolProve();
			CODPROVE=""+objRepsolprove.codproverubro;
			est=1;
 		 }
