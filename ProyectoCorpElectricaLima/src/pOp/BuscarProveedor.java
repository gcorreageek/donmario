...
*/
public class BuscarProveedor extends JDialog implements ActionListener, MouseListener, KeyListener {
	...
	DefaultTableModel modelo2 =new DefaultTableModel(null,titulo2);
	 ...
	 public BuscarProveedor(Frame padre) {
		 // padre y modal
		...
		try {
			...
			txtNombreProve.setText(objProd.NOMBRE_PROVEE);
