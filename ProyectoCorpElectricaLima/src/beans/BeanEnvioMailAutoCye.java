...
public class BeanEnvioMailAutoCye {
	...
	public BeanEnvioMailAutoCye() {
		super();
	}

	public BeanEnvioMailAutoCye(String id_mail, String fec_pemail,
			...
			String est_mail, String est_mail2, String ref) {
		super();
