...
*/
public class ConfigurarTuCuentaMasivo extends JInternalFrame implements ActionListener {
	...
	GlobalesCorreoMasivo objGlobalMasivo;
	GUI objGui;
	MenuPrincipal objMenu;
	Propiedades p=new Propiedades();
	
	public ConfigurarTuCuentaMasivo() {
		...
		try {
			...
			pnlConfiguracion.setBorder(BorderFactory.createTitledBorder("Configurar Cuenta Masivo"));
	...
	public void cargarDatos(){
		if(objGlobalMasivo.correo==null){
			
		}else{
			txtExtension.setText(objGlobalMasivo.extension);
			txtCorreo.setText(objGlobalMasivo.correo);
			txtPass.setText(objGlobalMasivo.pass);
			txtNombre.setText(objGlobalMasivo.nombre);
			txtCorreoErrores.setText(objGlobalMasivo.correoError);
		}
	...
	public void ingresoConfiguracion(){
		...
		if(extension.equals("")||correo.equals("")|pass.equals("")||nombre.equals("")||correoErrores.equals("")){
			...
			objGlobalMasivo.valor=false;
			//objMenu.mniConfigurar.setSelected(false);
		}else{
			objGui.mostrarAviso(extension+"\n"+correo+"\n"+pass+"\n"+nombre+"\n"+correoErrores);
			objGlobalMasivo.extension=extension;
			objGlobalMasivo.correo=correo;
			objGlobalMasivo.pass=pass;
			objGlobalMasivo.nombre=nombre;
			objGlobalMasivo.correoError=correoErrores;
			objGlobalMasivo.valor=true;
			//objMenu.mniConfigurar.setSelected(true);
		}
