...
public class PasarReporteExcelCorreo {
    ...
    public static String fec_Rep=""; 
   // public static String fecc_Rep=""; 
    public PasarReporteExcelCorreo() {
       clss=this. getClass();
    ...
    public static   void crearExcel(Object[] nombre,Object[][] datos,String fecRep)throws IOException{
  	   wb = new HSSFWorkbook();
       ...
       //objFec.convrtidorFec3(fec_Rep)
         String numCot=""+"REPORTE("+fec_Rep+")" ;
         numCot=numCot.replaceAll("  ", "");
         numCot=numCot.replaceAll(" ", "");
         numCot=numCot.trim();
         String fileRaiz="D:/ProyectoCEL/Cotizaciones/Reportes/";
    ...
    public static void metodoCorreoCel() throws IOException{
        ...
        /******************************************************************************************/
        /**************************************CORREO CEL******************************************/
        Sheet sheet3 = wb.createSheet("REPORTE DEL DIA " + fec_Rep);
      ...
      // style.setBorderRight(CellStyle.BORDER_THIN);
       ...
       sheet3.setColumnWidth(1, 9000);
       sheet3.setColumnWidth(2, 2200);
       sheet3.setColumnWidth(3, 4000); //10 characters wide
       sheet3.setColumnWidth(4, 4000);
       sheet3.setColumnWidth(5, 6500);
       sheet3.setColumnWidth(6, 3000);
       sheet3.setColumnWidth(7, 1100);
       sheet3.setColumnWidth(8, 900);
       sheet3.setColumnWidth(9, 18000);
      ...
      // Picture pict = drawing.createPicture(anchor, pictureIdx);
       ...
       Cell titulo = sheet3.createRow(5).createCell(5);
      ...
      /* Cell fecha = sheet3.createRow(12).createCell(4);
       ...
       fecha.setCellStyle(styles.get("title"));*/
        ...
        Row fila10=sheet3.createRow(6);
         ...
         celda1.setCellValue("RAZON SOCIAL");
         		  ...
         		  if(i<arreglo_datos.length && arreglo_datos[i][j]!=null){
             	      ...
             	      //  System.out.println("PINTA LENGUA:"+arreglo_datos[i-1][j].toString());
             	       ...
             	       // cell1.setCellStyle(styles.get("rrallamediosimpleFormat3"));
         				...
         				Cell cell2 = fila11.createCell(j+1);//+F22*$I$19
         				cell2.setCellValue(arreglo_datos[i][j].toString());
         				//cell2.setCellFormula(arreglo_datos[i-1][j].toString());
         				cell2.setCellStyle(styles.get("pinta")); 
         			  }else if(j==7){//+H22*B22
           				Cell cell2 = fila11.createCell(j+1);//
           				cell2.setCellValue(arreglo_datos[i][j].toString());
           				...
           				Cell cell2 = fila11.createCell(j+1);//
           				cell2.setCellValue(arreglo_datos[i][j].toString().trim());
             				//cell2.setCellFormula(arreglo_datos[i-1][j].toString());
             				cell2.setCellStyle(styles.get("pinta")); 
             		  }else if(j==9){//+H22*B22
           				//
