...
public class PasarProdExcel {
	 public static Class clss=null;
	 public static InputStream in;
	 public static ClassLoader cl = null;
	 public static Class kenyi=null;
	 public static InputStream lucia;
	 public static ClassLoader cl1=null;
	 /////////////////////////////
    ...
    public static String fec_Rep="",rubro=""; 
   // public static String fecc_Rep=""; 
    public PasarProdExcel() {
       clss=this. getClass();
    ...
    public static   void crearExcel(Object[] nombre,Object[][] datos,String numCoti,String cont)throws IOException{
    	try {
			wb = new HSSFWorkbook();
       ...
       //objFec.convrtidorFec3(fec_Rep)
         String numCot=""+"PRODUCTOS ("+fec_Rep+"-"+cont+")" ;
         numCot=numCot.replaceAll("  ", "");
         numCot=numCot.replaceAll(" ", "");
         numCot=numCot.trim();
         String fileRaiz="D:/ProyectoCEL/Cotizaciones/Productos/";
    ...
    public static void metodoCorreoCel() throws IOException{
        ...
        /******************************************************************************************/
        /**************************************CORREO CEL******************************************/
        Sheet sheet3 = wb.createSheet("PRODUCTOS" +"("+ fec_Rep +"-"+ rubro+")");
      ...
      // for (int i = 0; i < 250; i++) {	sheet3.createRow(i).setHeightInPoints(10);}
       ...
       sheet3.setColumnWidth(0, 800);
       sheet3.setColumnWidth(1, 2500);
       sheet3.setColumnWidth(2, 2500);
       sheet3.setColumnWidth(3, 25000); 
       sheet3.setColumnWidth(4, 9000);
      ...
      // Picture pict = drawing.createPicture(anchor, pictureIdx);
       ...
       titulo.setCellStyle(styles.get("titleMedio"));
       //+'HOJA DE COSTOS  INTERNA'!G2
        ...
        Row fila10=sheet3.createRow(6);
         ...
         for (int i = 0; i < arreglo_datos.length+1; i++) {//numero de filas 8 //aka se pone el arreglo
             ...
             for (int j = 0; j < 4; j++) {//numero de columnas 
            	 
         		  if(i<arreglo_datos.length && arreglo_datos[i][j]!=null){
         			 
         			  if(j==0){
         				 Cell cell1 = fila11.createCell(j+1);
                 	     cell1.setCellStyle(styles.get("pinta"));
                 	     cell1.setCellValue(arreglo_datos[i][j].toString());
             	      }
         			   ...
         			   else if(j==2){//+'COTIZACION - CLIENTE'!C18
         				Cell cell2 = fila11.createCell(j+1);//
           				cell2.setCellValue(arreglo_datos[i][j].toString());//cell2.setCellFormula("+'COTIZACION - CLIENTE'!C"+(16+i));
           				cell2.setCellStyle(styles.get("pinta"));  //unidad
          			  }
         			   else if(j==3){//+'COTIZACION - CLIENTE'!C18
         				Cell cell2 = fila11.createCell(j+1);//
           				cell2.setCellValue(arreglo_datos[i][j].toString());//cell2.setCellFormula("+'COTIZACION - CLIENTE'!C"+(16+i));
           				cell2.setCellStyle(styles.get("pinta"));  //unidad
         			  }else{
