...
public class PasarTareaExcelCorreo {
   ...
   // public static String fecc_Rep=""; 
    ...
    public static   void crearExcelTarea(Object[] nombre,Object[][] datos,String feccRep)throws IOException{
       ...
       //objFec.convrtidorFec3(fec_Rep)
         String numCot=""+"TAREA("+fecc_Rep+")" ;
         numCot=numCot.replaceAll("  ", "");
         numCot=numCot.replaceAll(" ", "");
         numCot=numCot.trim();
         String fileRaiz="D:/ProyectoCEL/Cotizaciones/Tareas/";
    ...
    public static void metodoCorreoCel() throws IOException{
        ...
        Sheet sheet4= wb.createSheet("TAREA DEL DIA"+ fecc_Rep);
      // for (int i = 0; i < 250; i++) {	sheet3.createRow(i).setHeightInPoints(10);}
        PrintSetup printSetup4=sheet4.getPrintSetup();
        printSetup4.setLandscape(true);
        sheet4.setFitToPage(true);
        sheet4.setHorizontallyCenter(true);
