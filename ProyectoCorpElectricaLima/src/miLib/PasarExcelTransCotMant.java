...
public class PasarExcelTransCotMant {
	 public static Class clss=null,clss1=null;
	 public static InputStream in;
	 public static ClassLoader cl = null,c2=null;
...
//	 public static String in2;
   ...
   public PasarExcelTransCotMant() throws IOException{  
	  clss=this. getClass();
   ...
   //D:\ProyectoCEM\Cotizaciones\CotCorreo
	...
	public static   void crearExcel2(Object[] nombre,Object[][] datos)throws IOException{
		   ...
		   String ref=objCot.sinEspacio(referencia);
	        ...
	        numCot=numCot.replaceAll(" ", "");
	        numCot=numCot.trim();
	        String fileRaiz=p.getProperty("fileRaiz");
   ...
   public static void crearExcel(Object[] nombre,Object[][] datos)throws IOException{
	   ClaseCargadora objCargar= new ClaseCargadora();
        ...
        String fileRaiz=p.getProperty("fileRaiz");//192.168.1.37/d/COTIZACIONES_CEL/";//"D:/ProyectoCEM/Cotizaciones/Cot/";
        String file =fileRaiz+numCot+".xls";
       // if(wb instanceof XSSFWorkbook) file += "x";
        GUI objGUI=new GUI() ;
      //  objGUI.mostrarAviso("EL File:"+file);
 	         FileOutputStream out = new FileOutputStream(file);
 	         System.out.println("Se ha generado el archivo excvel ne cotizaciones");
...
//        System.out.println("AKAAAAAAAAAAAAAAA TYO MIRA ESTO:"+objCargar.getCls().getResource(file).toString());
     ...
     // sheet.setColumnWidth(11, 6500);
      ...
      Row fila10=sheet.createRow(10);
       ...
       //sheet.addMergedRegion(CellRangeAddress.valueOf("B11:C11")); 
        ...
        Cell celda10=fila15.createCell(10);
        celda10.setCellValue("PESO CARRET.");
        celda10.setCellStyle(styles.get("titleCostadoCuadro"));
        
        Cell celda11=fila15.createCell(11);
        celda11.setCellValue("PESO TOTAL");
        celda11.setCellStyle(styles.get("titleCostadoCuadro"));
        
        Cell celda12=fila15.createCell(12);
        celda12.setCellValue("TIEMPO DE ENTREGA");
        celda12.setCellStyle(styles.get("titleCostadoCuadro"));
        
        Cell celda13=fila15.createCell(13);
        celda13.setCellValue("MODELO");
        celda13.setCellStyle(styles.get("titleCostadoCuadro"));
    	          ...
    	          celda5a10seiz.setCellStyle(styles.get("ralla"));
      			  ...
      			  if(j==0){
      				...
      				cell2.setCellStyle(styles.get("rrallamediosimpleFormat2")); 
        				...
        				Cell cell2 = fila16.createCell(j+1);//
          				cell2.setCellFormula("+'HOJA DE COSTOS  INTERNA'!P"+(10+i));
          				cell2.setCellStyle(styles.get("rrallamediosimpleFormat2")); 
          		  }else if(j==10){//+H18*B18
            				Cell cell2 = fila16.createCell(j+1);//
              				cell2.setCellFormula("+'HOJA DE COSTOS  INTERNA'!Q"+(10+i));
              				cell2.setCellStyle(styles.get("rrallamediosimpleFormat2")); 
              	  }else if(j==11){//+H18*B18
        				Cell cell2 = fila16.createCell(j+1);//
          				cell2.setCellFormula("+'HOJA DE COSTOS  INTERNA'!R"+(10+i));
          				cell2.setCellStyle(styles.get("rrallamediosimpleFormat2")); 
          		  }else if(j==12){//+H18*B18
      				Cell cell2 = fila16.createCell(j+1);//
      				cell2.setCellFormula("+'HOJA DE COSTOS  INTERNA'!S"+(10+i));
      				cell2.setCellStyle(styles.get("rrallamediosimpleFormat2")); 
          		  }else{
        ...
        Row fila17=sheet.createRow((arreglo_datos.length)+18);
  		...
  		for (int j = 0; j < 15; j++) {//numero de columnas YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY
  			if(i==0){
  			if(j!=0){
  			if(j==6){
    			...
    			celda1y17.setCellStyle(styles.get("dobleRallaHor"));
  				...
  				if(j==5){
  	  			...
  	  			Cell celda1y17=fila18.createCell(j);
  				celda1y17.setCellFormula("SUM(L18:L"+((arreglo_datos.length)+17)+")");
  				celda1y17.setCellStyle(styles.get("cuadradoSimpleChicoFormat"));
  	  			}else if(j==11){
  	  				//NADA
  	  			}else if(j==12){
   ...
   public static void metodoCotizacionInterna(){
     ...
     // style.setBorderRight(CellStyle.BORDER_THIN);
      ...
      sheet2.setColumnWidth(17, 6500);
      sheet2.setColumnWidth(18, 5500);
     ...
     //sheet.addMergedRegion(CellRangeAddress.valueOf("B11:C11"));
      ...
      //sheet.addMergedRegion(CellRangeAddress.valueOf("B11:C11"));
       ...
       //sheet.addMergedRegion(CellRangeAddress.valueOf("B11:C11")); 
        ...
        cell144.setCellValue("PESO UNIT.");
        cell145.setCellValue("Kg");
        
        fila9.createCell(15).setCellStyle(styles.get("mediaCajaArriba"));
        fila10.createCell(15).setCellStyle(styles.get("mediaCajaAbajo"));
        Cell cell146 = fila9.getCell(15);
        Cell cell147 = fila10.getCell(15);
        cell146.setCellValue("PESO CARRET.");
        cell147.setCellValue("Kg");
        
        fila9.createCell(16).setCellStyle(styles.get("mediaCajaArriba"));
        fila10.createCell(16).setCellStyle(styles.get("mediaCajaAbajo"));
        Cell cell148 = fila9.getCell(16);
        Cell cell149 = fila10.getCell(16);
        cell148.setCellValue("PESO TOTAL");
        cell149.setCellValue("Kg");
       
        fila9.createCell(17).setCellStyle(styles.get("cuadradoMedioDobleRalla"));
        fila10.createCell(17).setCellStyle(styles.get("cuadradoMedioDobleRalla"));
        Cell cell17 = fila9.getCell(17);
        cell17.setCellValue("TIEMPO DE ENTREGA");
        sheet2.addMergedRegion(CellRangeAddress.valueOf("$R$9:$R$10"));
        
        fila9.createCell(18).setCellStyle(styles.get("cuadradoMedioDobleRalla"));
        fila10.createCell(18).setCellStyle(styles.get("cuadradoMedioDobleRalla"));
        Cell cell18 = fila9.getCell(18);
        cell18.setCellValue("MODELO");
        sheet2.addMergedRegion(CellRangeAddress.valueOf("$S$9:$S$10"));
        	...
        	Row fila11=sheet2.createRow(10+i);
        	  for (int j = 0; j < 20; j++) {//numero de columnas 
        		...
        		if(j==0){
        			...
        			//AQUI SE PONE EL NOMBRE O DESCRIPCION DEL PRODUCTO
        			if(i<arreglo_datos.length){
        			...
        			//(G10-I10)
        		}else if(j==15){//J10/G10
        			if(i<arreglo_datos.length){//
            			Cell celda10y0=fila11.createCell(j);
            			celda10y0.setCellValue(Double.parseDouble(""+arreglo_datos[i][10]));
          				celda10y0.setCellStyle(styles.get("rrallamediosimple"));		
            			}else{
            			Cell celda10y0=fila11.createCell(j);
              			celda10y0.setCellStyle(styles.get("rrallamediosimple"));	
        			...
        			//(G10-I10)
        		}else if(j==16){//J10/G10
        			if(i<arreglo_datos.length){//
            			Cell celda10y0=fila11.createCell(j);
            			celda10y0.setCellFormula("(O"+(11+i)+"*B"+(11+i)+")+P"+(11+i));
          				celda10y0.setCellStyle(styles.get("rrallamediosimple"));		
            			}else{
            			Cell celda10y0=fila11.createCell(j);
              			celda10y0.setCellStyle(styles.get("rrallamediosimple"));	
        			...
        			//(G10-I10)
        		}else if(j==17){//J10/G10
        			if(i<arreglo_datos.length){//
            			Cell celda10y0=fila11.createCell(j);
            			celda10y0.setCellValue(""+arreglo_datos[i][11]);
          				celda10y0.setCellStyle(styles.get("rrallamediosimple"));		
            			}else{
            			Cell celda10y0=fila11.createCell(j);
              			celda10y0.setCellStyle(styles.get("rrallamediosimple"));	
        			...
        			//(G10-I10)
        		}else if(j==18){//J10/G10
        			if(i<arreglo_datos.length){//
            			Cell celda10y0=fila11.createCell(j);
            			celda10y0.setCellValue(""+arreglo_datos[i][12]);
          				celda10y0.setCellStyle(styles.get("rrallamediosimple"));		
            			}else{
            			Cell celda10y0=fila11.createCell(j);
              			celda10y0.setCellStyle(styles.get("rrallamediosimple"));	
      ...
      //SUMA(G10:G214)
  	  //if(i==(arreglo_datos.length)){
  		...
  		for (int j = 0; j < 19; j++) {//NUMERO DE COLUMNAS 
  			if(i==0){
  			if(j==5){
  				Cell celda10y0=fila17.createCell(j);
      			celda10y0.setCellValue("P.VENTA");
  				...
  				Cell celda1y17=fila17.createCell(j);
  				celda1y17.setCellFormula("SUM(P11:P"+(10+(arreglo_datos.length))+")");
  				celda1y17.setCellStyle(styles.get("dobleRallaHor"));
  			}else if(j==16){
  				Cell celda1y17=fila17.createCell(j);
  				celda1y17.setCellFormula("SUM(Q11:Q"+(10+(arreglo_datos.length))+")");
  				celda1y17.setCellStyle(styles.get("dobleRallaHor"));
  			}else if(j==17){
  				Cell celda1y17=fila17.createCell(j);
  				celda1y17.setCellStyle(styles.get("dobleRallaHor"));
   ...
   // public static InputStream in;
     ...
     // anchor.setCol1(3);
      ...
      //sheet.addMergedRegion(CellRangeAddress.valueOf("B11:C11"));
       ...
       Row fila17=sheet3.createRow(17);
        ...
        //titleCostadoCuadroRojo titleCostadoCuadroAmarillo
        Cell tipo = filanUEVA.createCell(7);
        tipo.setCellValue("T.C.");
        		  ...
        		  if(j==4){
        			  ...
        			  if(j==0){
            			...
            			cell2.setCellStyle(styles.get("rrallamediosimpleFormat2")); 
            				...
            				Cell cell2 = fila19.createCell(j+1);//
              				cell2.setCellFormula("+'COTIZACION - CLIENTE'!K"+(17+i));
                			cell2.setCellStyle(styles.get("rrallamediosimpleFormat2")); 
                	  }else if(j==10){//+H22*B22
            				Cell cell2 = fila19.createCell(j+1);//
              				cell2.setCellFormula("+'COTIZACION - CLIENTE'!L"+(17+i));
                			cell2.setCellStyle(styles.get("rrallamediosimpleFormat2")); 
                	  }else if(j==11){//+H22*B22
            				Cell cell2 = fila19.createCell(j+1);//
              				cell2.setCellFormula("+'COTIZACION - CLIENTE'!M"+(17+i));
                			cell2.setCellStyle(styles.get("rrallamediosimpleFormat2")); 
                	  }else if(j==12){//+H22*B22
          				Cell cell2 = fila19.createCell(j+1);//
          				cell2.setCellFormula("+'COTIZACION - CLIENTE'!N"+(17+i));
            			cell2.setCellStyle(styles.get("rrallamediosimpleFormat2")); 
                	  }/**/else{
        ...
        Row fila20=sheet3.createRow((arreglo_datos.length)+22);
  		...
  		for (int i = 0; i < 43; i++) {
			...
			celda10y0.setCellStyle(styles.get("titleCostadoSimple"));
  	  	  	...
  	  	  	Cell celda10y0=fila24.createCell(3);
			celda10y0.setCellValue(cargar(11));
			celda10y0.setCellStyle(styles.get("tituloMedioRojo"));
    ...
    private static Map<String, CellStyle> createStyles(Workbook wb){
      ...
      //CUADRADO MEDIO Y ABAJO DOBLE RALLA
        ...
        Font tituloMedioRojo = wb.createFont();
        tituloMedioRojo.setFontHeightInPoints((short)12);//Esto es para ponerle el tamaño al titulo
        tituloMedioRojo.setBoldweight(Font.COLOR_NORMAL);//Si es Negrita O no Es Negrita
        tituloMedioRojo.setColor(HSSFColor.WHITE.index);
        style = wb.createCellStyle();
        style.setAlignment(CellStyle.ALIGN_CENTER);//Centro,Costados
        style.setVerticalAlignment(CellStyle.VERTICAL_CENTER);//Centro,Costados
        style.setFont(tituloMedioRojo); 
        style.setFillForegroundColor(IndexedColors.RED.getIndex());
        style.setFillPattern(CellStyle.SOLID_FOREGROUND);
        styles.put("tituloMedioRojo", style);
